    ...
    <div class="col-xl-5 col-sm-5 mb-3">
              <div class="card text-white bg-success o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5 head">Add New Department</div>
                </div>
                <a class="card-footer text-white clearfix small z-1" href="deptform">
            ...
            <div class="col-xl-5 col-sm-5 mb-3">
              <div class="card text-white bg-danger o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5 head">View Departments</div>
                </div>
                <a class="card-footer text-white clearfix small z-1" href="viewdept">
