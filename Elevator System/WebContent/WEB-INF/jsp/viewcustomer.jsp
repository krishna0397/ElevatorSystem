...
table,th,td{text-align:center;}
  ...
  <body>
   ...
   <div class="container shadow p-3 mb-5 bg-light rounded table table-responsive">
	<h1 style="color:blueviolet" align="center" >Customer List</h1>
	<br>
	...
	<br><br>
	<table class="table table-striped table-hover" align="center" id="myTable" border="2" width="70%" cellpadding="2">
		<tr>
			<th>ID</th>
			<th>Name</th>
			<th>Email</th>
		...
		<c:forEach var="customer" items="${list}">
			<tr>
				...
				<td><a class="btn btn-primary btn-danger" href="deletecustomer/${customer.customer_id}">Delete <i class='far fa-trash-alt'></i></a></td>
			</tr>
		</c:forEach>
	</table>
	<br/>
