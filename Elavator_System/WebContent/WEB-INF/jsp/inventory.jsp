...
<body>
  ...
  <body id="page-top">
	...
	<br>
     ...
     <div class="row justify-content-around shadow-sm p-3 mb-5 bg-light rounded">
    <div class="col-xl-5 col-sm-5 mb-3">
              <div class="card text-white bg-success o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5 head">Add New Product</div>
                </div>
                <a class="card-footer text-white clearfix small z-1" href="productform">
            ...
            <div class="col-xl-5 col-sm-5 mb-3">
              <div class="card text-white bg-danger o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5 head">View Product</div>
                </div>
                <a class="card-footer text-white clearfix small z-1" href="viewproduct">
           ...
           <div class="col-xl-5 col-sm-5 mb-3"> 
               <div class="card text-white bg-info o-hidden h-100"> 
                 <div class="card-body"> 
                   ...
                   <div class="mr-5 head">Gst & Discount</div> 
                 </div> 
                <a class="card-footer text-white clearfix small z-1" href="gstdiscountform"> 
                   <span class="float-left">Set GST And Discount</span> 
                  <span class="float-right"> 
                     <i class="fa fa-inr"></i> 
                   </span> 
                 </a> 
