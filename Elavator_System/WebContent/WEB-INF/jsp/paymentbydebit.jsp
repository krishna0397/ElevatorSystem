...
<div class="page-header">
	<h1>Payment By Debit Card</h1>
</div>

<!-- Credit Card Payment Form - START -->
<form:form method="get" action="debitpayment">
<div class="container">
    <div class="row">
                            ...
                            <div class="col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <form:input path="debitcardno" type="tel" class="form-control" minlength='16' maxlength='16' pattern="[0-9]{16}" onKeyPress= "return validateMobNo(event.key);" placeholder="Valid Card Number" required="required"/>
                          ...
                          <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    ...
                                    <form:input path="debitname" type="text" class="form-control" placeholder="Card Owner Names" required="required"/>
                                </div>
                            </div>
                        </div>
                    </form>
