...
<body>
  ...
  <body id="page-top">
	...
	<div class="container shadow-sm p-3 mb-5 bg-light rounded table table-responsive">
	<h1 style="color:blueviolet;font-weight:600;" align="center">Ordered List</h1><br>
	<a href="makeorder" class="btn btn-primary">Make New Order</a><br><br>
