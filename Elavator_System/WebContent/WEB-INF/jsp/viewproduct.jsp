...
table,th,td{text-align:center;}
  ...
  <body>
	...
	<h1 style="color:blueviolet" align="center">Product List</h1><br>
	...
	<table class="table table-striped table-hover" id="myTable" align="center" border="2" width="70%" padding="5px">
		<tr>
			...
			<th> Cost Price of a Quantity</th>
			<th> Selling Amount per Quantity</th>
			<th>Edit</th>
			<th>Delete</th>
		</tr>
		<% int i=1; %>
		<c:forEach var="product" items="${list}">
			<tr>
				...
				<td><a class="btn btn-primary btn-sm btn-info" href="editproduct/${product.product_id}">Edit  <i class='far fa-edit'></a></td>
				<td><a class="btn btn-primary btn-danger btn-sm" href="deleteproduct/${product.product_id}">Delete  <i class='far fa-trash-alt'></i></a></td>
			</tr>
		</c:forEach>
	</table>
	<br />

	<a  class="btn btn-primary btn-sm"href="productform">Add New Product</a>
	<br>
