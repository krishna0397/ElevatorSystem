...
<body>
	...
	<nav class="navbar navbar-expand navbar-dark static-top" style="background-color:rebeccapurple"> 
	...
	<div class="container shadow p-3 mb-5 bg-light rounded table table-responsive">
		<h1 style="color: blueviolet" align="center">Messages</h1><br>
		<table class="table table-striped table-hover" align="center" border="2" width="70%" cellpadding="2">
			...
			<c:forEach var="msg" items="${list}">
				<tr>
					...
					<td><a class="btn btn-primary btn-sm btn-danger" href="deletemsg/${msg.fname}">Delete <i class='far fa-trash-alt'></i></a></td>
				</tr>
			</c:forEach>
		</table>
		<br />
