...
<div class="row shadow p-3 mb-5 bg-light rounded ">
	...
	<h1 style="color:blueviolet" align="center">Employees List</h1>
	<br>
	...
	<table class="table table-striped table-hover" id="myTable" align="center" border="2" width="70%" cellpadding="2">
		...
		<c:forEach var="emp" items="${list}">
			<tr>
				...
				<td><a class="btn btn-primary btn-sm btn-info" href="editemp/${emp.employee_id}">Edit <i class='far fa-edit'></i></a></td>
				<td><a class="btn btn-primary btn-sm btn-danger" href="deleteemp/${emp.employee_id}">Delete <i class='far fa-trash-alt'></i></a></td>
			</tr>
		</c:forEach>
	</table>
	<br />

	<a class="btn btn-primary btn-sm" href="empform">Add New Employee</a>
</div>
</div>
