    ...
    <div class="row">
        ...
        <div class="col-xs-12">
    		<div class="invoice-title">
    			<a href="#" id="printbtn" class="btn btn-primary btn-info btn-sm pull-right" style="position:absolute; top:10px;right:20px;" onclick="document.getElementById('printbtn').style.visibility ='hidden'; document.getElementById('cnfrpaid').style.visibility ='hidden'; window.print(); document.getElementById('cnfrpaid').style.visibility ='visible';">Print <i class="fa fa-print" style="font-size:15px;"></i></a><br><br>
    		...
    		<div class="row">
    			...
    			<div class="col-xs-6 text-right">
        			...
        			<strong>Shipped To:</strong><br>
        			 	 Name: ${list.customer_name}<br>
    					Address:  ${list.customer_address}<br>
    					Mob No.: ${list.customer_mobileno}
		...
		<tr>
			<td colspan="6"  style="position:relative;"><br><strong><span  style="position:absolute;right:50px;bottom:15px;">TOTAL = ${total} Rs</span></strong><br></td>
			    ...
			    <div class="row">
			        ...
			        <div class="col-md-2">
			        <c:set var="gstpercent" value="${item1.gst }"/>
...
<!--   				<a href="gstdiscountform" class="btn btn-primary"  id="gstdiscount">Change GST & DISCOUNT <i class="fa fa-edit"></i></a> -->
				...
				<div class="col-md-10">
                   ...
                   <div class="col-md-2">
                    ...
                    <c:set var="total" value="${total+amt1-amt2}"></c:set>
                    <h3><c:out value="${total}"/></h3><br>
    			...
    			<button type="submit" id="cnfrpaid" class="btn btn-success btn-md">Confirm And Paid</button><br>
    			
    			<div class="row">
    			<div class="col-md-12 text-justified" style="text-align:center;">
    			<h3 style="display:inline;">*</h3>On every product you will get 3 years of service oriented warranty.<br><br>
    				Thanks for purchasing our product.Visit again!!!
    			</div>
    			</div>
    				</div>
    			</div>
