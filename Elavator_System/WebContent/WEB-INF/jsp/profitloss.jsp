  ...
  <body id="page-top">
     ...
     <nav class="navbar navbar-expand navbar-dark static-top" style="background-color: mediumvioletred;">
      ...
      <ul class="navbar-nav ml-auto ml-md-0">
        ...
        <div class="col-md-4">
        <li class="nav-item dropdown no-arrow">
           <a href="${pageContext.request.contextPath}/messages" data-toggle="tooltip" title="Message"><i style="color: white; "class="fas fa-envelope fa-lg "></i></a>
        </li>
        </div>
...
<%--                <td><a href="approved/${product.order_id}" class="btn btn-info btn-sm">Approve<i class="fa fa-check"></i></a></td> --%>
		...
		<div class="panel col-md-3" style="background-color:aliceblue; color:darkgreen;position:absolute;top:5px;left:10px;height:20%">
